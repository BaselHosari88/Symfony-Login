 ...
 */
final class Version20230606130711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lesson ADD user_id INT DEFAULT NULL, ADD training_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lesson DROP user_id, DROP training_id');
